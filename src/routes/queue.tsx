            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
              <div className="space-y-4">
                ...
                <div className="flex items-baseline gap-6">
                  <span className="text-7xl sm:text-9xl font-black font-mono tracking-tighter tabular-nums text-white">
                    {nowServing ? `#${nowServing.queue_number}` : "—"}
                  </span>
                  {nowServing ? (
                    <div className="space-y-1">
                      <h3 className="text-3xl sm:text-4xl font-extrabold uppercase tracking-tight text-zinc-100">
                        {nowServing.first_name || "Guest"}
                      </h3>
                      <p className="text-sm font-mono text-zinc-400">
                        Estimated Service Time: ~{nowServing.duration_minutes || 30} mins
                      </p>
                    </div>
                  ) : (
                    <div className="space-y-1">
              ...
              <div className="border-t md:border-t-0 md:border-l border-zinc-800 pt-6 md:pt-0 md:pl-10 text-left md:text-right font-mono">
                ...
                <div className="text-xs text-zinc-400 mt-2">
                  Average wait: ~{waiting.length * 30} mins
                </div>
              </div>
            </div>
          </div>
