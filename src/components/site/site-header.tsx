      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 md:px-10">
        ...
        <nav className="hidden items-center gap-7 lg:flex">
          {NAV.map((n) => (
            <Link
              ...
              to={n.to}
              className={cn(
                "text-xs font-bold tracking-[0.18em] text-zinc-500 transition-all duration-200",
        ...
        <Sheet>
          <SheetTrigger asChild>
            <Button variant="outline" size="icon" className="md:hidden rounded-none border-zinc-300 dark:border-zinc-700">
